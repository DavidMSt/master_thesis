    ...
    const app = createApp({
        template: `
          ...
          <div id="terminal-window" style="display:flex; flex-direction:column; height:100%; width:100%">
            ...
            <div class="terminal-overlay" v-if="!terminalWsStatus.connected">
              <!--              <span class="terminal-overlay-title">Terminal</span>-->
              <span class="terminal-overlay-title">Not connected</span>
              <span class="terminal-overlay-info">{{ wsUrl }}</span>
            </div>
        ...
        setup() {
            ...
            // — WebSocket hookup —
            function connectTerminalWebSocket() {
                terminalWs = new WebSocket(`ws://localhost:${WEBSOCKET_PORT}`);
                terminalWs.onopen = () => {
                    addLog("Terminal Websocket connected", "green");
                    terminalWsStatus.connected = true;
                };
