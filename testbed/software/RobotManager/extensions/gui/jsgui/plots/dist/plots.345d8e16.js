...
})({"7wROf":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e56407fd345d8e16";
"use strict";
...
},{}],"8WlYD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "streamingChart", ()=>streamingChart);
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _chartjsAdapterMoment = require("chartjs-adapter-moment"); // Time adapter
var _chartjsPluginStreaming = require("chartjs-plugin-streaming");
var _chartjsPluginStreamingDefault = parcelHelpers.interopDefault(_chartjsPluginStreaming);
// Register the streaming plugin
(0, _autoDefault.default).register((0, _chartjsPluginStreamingDefault.default));
// Keep a reference to the default legend onClick and generateLabels
const defaultLegendClick = (0, _autoDefault.default).defaults.plugins.legend.onClick;
const defaultGenerateLabels = (0, _autoDefault.default).defaults.plugins.legend.labels.generateLabels;
// Configuration constants
const UPDATE_INTERVAL_MS = 100; // how often to fetch new data (in ms)
let WINDOW_DURATION_MS = 15000; // initial time window size (in ms)
// Get canvas context
...
const streamingChart = new (0, _autoDefault.default)(ctx, {
    type: 'line',
    data: {
        datasets: [
            {
        ...
        scales: {
            ...
            yDownload: {
                ...
                grid: {
                    ...
                    color: (ctx)=>ctx.tick.value === 0 ? 'rgba(237,18,237,1)' : 'rgba(237,18,237,0.4)'
                },
                min: -100,
                max: 100
            },
...
},{"chart.js/auto":"dfKt4","chartjs-adapter-moment":"40d5I","chartjs-plugin-streaming":"gVVny","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dfKt4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../dist/chart.mjs":"8sLy8","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8sLy8":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v3.9.1
...
},{"./chunks/helpers.segment.mjs":"ivU3a","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ivU3a":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v3.9.1
 * https://www.chartjs.org
 * (c) 2022 Chart.js Contributors
...
},{}],"40d5I":[function(require,module,exports,__globalThis) {
/*!
...
},{"moment":"kty5A","chart.js":"8sLy8","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kty5A":[function(require,module,exports,__globalThis) {
//! moment.js
//! version : 2.30.1
...
},{}],"gVVny":[function(require,module,exports,__globalThis) {
/*!
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RealTimeScale", ()=>RealTimeScale);
parcelHelpers.export(exports, "StreamingPlugin", ()=>StreamingPlugin);
var _chartJs = require("chart.js");
...
function resolveOption(scale, key) {
    ...
    return (0, _helpers.valueOrDefault)(realtimeOpts[key], streamingOpts[key]);
}
function getAxisMap(element, { x, y }, { xAxisID, yAxisID }) {
    const axisMap = {};
    (0, _helpers.each)(x, (key)=>{
        axisMap[key] = {
            axisId: xAxisID
        };
    });
    (0, _helpers.each)(y, (key)=>{
        axisMap[key] = {
            axisId: yAxisID
        };
    });
...
const cancelAnimFrame = function() {
    if (typeof window === 'undefined') return 0, _helpers.noop;
...
function startFrameRefreshTimer(context, func) {
    if (!context.frameRequestID) {
        const refresh = ()=>{
            ...
            const now = Date.now();
            if (nextRefresh <= now) {
                const newFrameRate = (0, _helpers.callback)(func);
            ...
            context.frameRequestID = (0, _helpers.requestAnimFrame).call(window, refresh);
        };
        context.frameRequestID = (0, _helpers.requestAnimFrame).call(window, refresh);
    }
}
...
function startDataRefreshTimer(context, func, interval) {
    if (!context.refreshTimerID) {
        context.refreshTimerID = setInterval(()=>{
            const newInterval = (0, _helpers.callback)(func);
...
function scaleValue(scale, value, fallback) {
    ...
    return (0, _helpers.isFinite)(value) ? {
...
function updateBoxAnnotation(element, chart, options) {
    ...
    if (xScale) {
        ...
        if (min.transitionable) streaming[reverse ? 'x2' : 'x'] = {
            axisId: xScaleID
        };
        if (max.transitionable) streaming[reverse ? 'x' : 'x2'] = {
            axisId: xScaleID
        };
        if (min.transitionable !== max.transitionable) streaming.width = {
            axisId: xScaleID,
    ...
    if (yScale) {
        ...
        const reverse = min.value > max.value;
        if (min.transitionable) streaming[reverse ? 'y2' : 'y'] = {
            axisId: yScaleID
        };
        if (max.transitionable) streaming[reverse ? 'y' : 'y2'] = {
            axisId: yScaleID
        };
        if (min.transitionable !== max.transitionable) streaming.height = {
            axisId: yScaleID,
            reverse: min.transitionable
        };
    }
...
function updateLineAnnotation(element, chart, options) {
    ...
    if (xScale) {
        ...
        if (min.transitionable) streaming.x = {
            axisId: xScaleID
        };
        else clip.left = left;
        if (max.transitionable) streaming.x2 = {
            axisId: xScaleID
        };
        else clip.right = right;
    }
    if (yScale) {
        const min = scaleValue(yScale, yMin);
        const max = scaleValue(yScale, yMax);
        if (min.transitionable) streaming.y = {
            axisId: yScaleID
        };
        else clip.top = top;
        if (max.transitionable) streaming.y2 = {
            axisId: yScaleID
        };
        else clip.bottom = bottom;
    }
    return clip;
}
function updatePointAnnotation(element, chart, options) {
    ...
    if (xScale) {
        ...
        if (x.transitionable) streaming.x = {
            axisId: xScaleID
        };
    }
    if (yScale) {
        const y = scaleValue(yScale, yValue);
        if (y.transitionable) streaming.y = {
            axisId: yScaleID
        };
    }
}
function initAnnotationPlugin() {
    const BoxAnnotation = (0, _chartJs.registry).getElement('boxAnnotation');
    const LineAnnotation = (0, _chartJs.registry).getElement('lineAnnotation');
    const PointAnnotation = (0, _chartJs.registry).getElement('pointAnnotation');
...
function attachChart$1(plugin, chart) {
    ...
    if (streaming.annotationPlugin !== plugin) {
        ...
        plugin.afterUpdate = (_chart, args, options)=>{
            ...
            if (mode === 'quiet') options.animation = false;
            afterUpdate.call(this, _chart, args, options);
            if (mode === 'quiet') options.animation = animationOpts;
        };
    }
}
...
function storeOriginalScaleOptions(chart) {
    ...
    const scales = chart.scales;
    (0, _helpers.each)(scales, (scale)=>{
        const id = scale.id;
        if (!originalScaleOptions[id]) originalScaleOptions[id] = {
            duration: resolveOption(scale, 'duration'),
            delay: resolveOption(scale, 'delay')
        };
    });
    (0, _helpers.each)(originalScaleOptions, (opt, key)=>{
        if (!scales[key]) delete originalScaleOptions[key];
    });
...
function zoomRealTimeScale(scale, zoom, center, limits) {
    ...
    if (scale.isHorizontal()) maxPercent = (scale.right - center.x) / (scale.right - scale.left);
    else maxPercent = (scale.bottom - center.y) / (scale.bottom - scale.top);
...
function resetRealTimeScaleOptions(chart) {
    ...
    (0, _helpers.each)(chart.scales, (scale)=>{
...
function determineStepSize(min, max, unit, capacity) {
    ...
    for(let i = 0, ilen = steps.length; i < ilen; ++i){
        factor = steps[i];
        if (Math.ceil(range / (milliseconds * factor)) <= capacity) break;
    }
    return factor;
}
function determineUnitForAutoTicks(minUnit, min, max, capacity) {
    ...
    for(let i = UNITS.indexOf(minUnit); i < ilen - 1; ++i){
        ...
        if (common && Math.ceil(range / (factor * size)) <= capacity) return UNITS[i];
    }
    return UNITS[ilen - 1];
}
function determineMajorUnit(unit) {
...
function addTick(ticks, time, timestamps) {
    if (!timestamps) ticks[time] = true;
        ...
        const { lo, hi } = (0, _helpers._lookup)(timestamps, time);
        const timestamp = timestamps[lo] >= time ? timestamps[lo] : timestamps[hi];
        ticks[timestamp] = true;
    }
}
...
function clean(scale) {
    ...
    (0, _helpers.each)(chart.data.datasets, (dataset, datasetIndex)=>{
        const meta = chart.getDatasetMeta(datasetIndex);
        ...
        if (axis) {
            ...
            if (pause) {
                for(i = 0; i < length; ++i){
                    ...
                    if (point && !(point[axis] < max)) break;
                }
                start = i + 2;
            } else start = 0;
            for(i = start; i < length; ++i){
                const point = controller.getParsed(i);
                if (!point || !(point[axis] <= min)) break;
            }
            count = i - start;
            if (isNaN(ttl)) count = Math.max(count - 2, 0);
            data.splice(start, count);
            (0, _helpers.each)(datasetPropertyKeys, (key)=>{
                if ((0, _helpers.isArray)(dataset[key])) dataset[key].splice(start, count);
            });
            (0, _helpers.each)(dataset.datalabels, (value)=>{
                if ((0, _helpers.isArray)(value)) value.splice(start, count);
            });
            if (typeof data[0] !== 'object') removalRange = {
                start: start,
                count: count
            };
            (0, _helpers.each)(chart._active, (item, index)=>{
                if (item.datasetIndex === datasetIndex && item.index >= start) {
                    if (item.index >= start + count) item.index -= count;
                    else chart._active.splice(index, 1);
                }
            }, null, true);
        }
    });
    if (removalRange) chart.data.labels.splice(removalRange.start, removalRange.count);
}
function transition(element, id, translate) {
    const animations = element.$animations || {};
    (0, _helpers.each)(element.$streaming, (item, key)=>{
        if (item.axisId === id) {
            const delta = item.reverse ? -translate : translate;
            const animation = animations[key];
            if ((0, _helpers.isFinite)(element[key])) element[key] -= delta;
            if (animation) {
...
function scroll(scale) {
    ...
    if (isHorizontal === !!scale.options.reverse) offset = -offset;
    (0, _helpers.each)(chart.data.datasets, (dataset, datasetIndex)=>{
        const meta = chart.getDatasetMeta(datasetIndex);
        const { data: elements = [], dataset: element } = meta;
        for(let i = 0, ilen = elements.length; i < ilen; ++i)transition(elements[i], id, offset);
        if (element) {
            transition(element, id, offset);
            delete element._path;
        }
    });
    for(let i = 0, ilen = annotations.length; i < ilen; ++i)transition(annotations[i], id, offset);
    if (tooltip) transition(tooltip, id, offset);
    scale.max = now - delay;
    scale.min = scale.max - duration;
    realtime.head = now;
}
class RealTimeScale extends (0, _chartJs.TimeScale) {
    constructor(props){
        super(props);
    ...
    update(maxWidth, maxHeight, margins) {
        ...
        if (resolveOption(me, 'pause')) stopFrameRefreshTimer(realtime);
        else {
            if (!realtime.frameRequestID) realtime.head = Date.now();
            startFrameRefreshTimer(realtime, ()=>{
                const chart = me.chart;
                const streaming = chart.$streaming;
                scroll(me);
                if (streaming) (0, _helpers.callback)(streaming.render, [
                    chart
                ]);
    ...
    _generate() {
        ...
        const hasWeekday = (0, _helpers.isNumber)(weekday) || weekday === true;
        ...
        for(count = 0; time < max + refresh; time = +adapter.add(time, stepSize, minor), count++)addTick(ticks, time, timestamps);
        if (time === max + refresh || count === 1) addTick(ticks, time, timestamps);
        return Object.keys(ticks).sort((a, b)=>a - b).map((x)=>+x);
    }
}
...
(0, _chartJs.defaults).describe('scale.realtime', {
    _scriptable: (name)=>name !== 'onRefresh'
});
var version = "2.0.0";
(0, _chartJs.defaults).set('transitions', {
    quiet: {
        animation: {
            duration: 0
        }
...
function update(mode) {
    const me = this;
    if (mode === 'quiet') (0, _helpers.each)(me.data.datasets, (dataset, datasetIndex)=>{
        const controller = me.getDatasetMeta(datasetIndex).controller;
        controller._setStyle = function(element, index, _mode, active) {
            (0, _chartJs.DatasetController).prototype._setStyle.call(this, element, index, 'quiet', active);
        };
    });
    (0, _chartJs.Chart).prototype.update.call(me, mode);
    if (mode === 'quiet') (0, _helpers.each)(me.data.datasets, (dataset, datasetIndex)=>{
...
function render(chart) {
    const streaming = chart.$streaming;
    chart.render();
    if (streaming.lastMouseEvent) setTimeout(()=>{
        const lastMouseEvent = streaming.lastMouseEvent;
        if (lastMouseEvent) chart._eventHandler(lastMouseEvent);
    }, 0);
}
var StreamingPlugin = {
    id: 'streaming',
    ...
    beforeInit (chart) {
        ...
        const mouseEventListener = streaming.mouseEventListener = (event)=>{
            const pos = (0, _helpers.getRelativePosition)(event, chart);
    ...
    beforeUpdate (chart) {
        ...
        const tooltip = chart.tooltip;
        (0, _helpers.each)(scales, ({ type })=>{
            if (type === 'realtime') elements.line.capBezierPoints = false;
        });
        if (tooltip) tooltip.update = update$1;
        try {
            const plugin = (0, _chartJs.registry).getPlugin('annotation');
            attachChart$1(plugin, chart);
        } catch (e) {
            detachChart$1(chart);
        }
        try {
            const plugin = (0, _chartJs.registry).getPlugin('zoom');
    ...
    beforeDatasetUpdate (chart, args) {
        ...
        if (mode === 'quiet') {
            ...
            if ($animations && $animations.visible && $animations.visible._active) {
                controller.updateElement = (0, _helpers.noop);
                controller.updateSharedOptions = (0, _helpers.noop);
            }
        }
    },
    afterDatasetUpdate (chart, args) {
        ...
        for(let i = 0, ilen = elements.length; i < ilen; ++i)elements[i].$streaming = getAxisMap(elements[i], transitionKeys, meta);
        if (element) element.$streaming = getAxisMap(element, transitionKeys, meta);
        if (mode === 'quiet') {
    ...
    beforeEvent (chart, args) {
        ...
        if (event.type === 'mousemove') streaming.lastMouseEvent = event;
        else if (event.type === 'mouseout') delete streaming.lastMouseEvent;
    },
    destroy (chart) {
        const { scales, $streaming: streaming, tooltip } = chart;
        const { canvas, mouseEventListener } = streaming;
        delete chart.update;
        if (tooltip) delete tooltip.update;
        canvas.removeEventListener('mousedown', mouseEventListener);
        canvas.removeEventListener('mouseup', mouseEventListener);
        (0, _helpers.each)(scales, (scale)=>{
            if (scale instanceof RealTimeScale) scale.destroy();
        });
    },
    defaults: {
        duration: 10000,
...
exports.default = registerables;

},{"chart.js":"8sLy8","chart.js/helpers":"jHmkJ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jHmkJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helpersMjs = require("../dist/helpers.mjs");
parcelHelpers.exportAll(_helpersMjs, exports);

},{"../dist/helpers.mjs":"6CP4z","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6CP4z":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v3.9.1
 * https://www.chartjs.org
 * (c) 2022 Chart.js Contributors
...
},{"./chunks/helpers.segment.mjs":"ivU3a","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7wROf","8WlYD"], "8WlYD", "parcelRequire30ab", {})

//# sourceMappingURL=plots.345d8e16.js.map
