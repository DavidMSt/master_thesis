...
class TaskAssignmentAgent(FRODO_TestAgent):
    def __init__(self, Ts, agent_id="frodo1v", is_task_agent=True):
    ...
    def extract_task_configurations(self, tasks: list[Task]) -> list[Task]:
        """
...
if __name__ == "__main__":
    # Example usage
    agent = TaskAssignmentAgent(Ts=0.1)
